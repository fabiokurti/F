...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/chat` | `/chat` | `/(auth)/register` | `/register` | `/(auth)/signIn` | `/signIn` | `/(auth)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/two` | `/two` | `/(tabs)/_layout` | `/+html` | `/modal` | `/(tabs)/three` | `/three`;
  // prettier-ignore
