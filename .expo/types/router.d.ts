...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/chat` | `/chat` | `/(auth)/register` | `/register` | `/(auth)/signIn` | `/signIn` | `/(auth)/_layout` | `/_layout` | `/(tabs)/three` | `/three` | `/(tabs)/two` | `/two` | `/(tabs)/_layout` | `/+html` | `/modal` | `/(tabs)/` | `/(tabs)`;
  // prettier-ignore
